...
split_points_fileName = sys.argv[
    4
]  # $outputDataDir/demDerived_reaches_split_points.gpkg
...
if lakes is not None:
    ...
    split_flows_gdf = split_flows_gdf.rename(columns={"index_right": "LakeID"}).fillna(
        -999
    )
else:
