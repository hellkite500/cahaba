...
ble_sites.remove('all_test_cases_huc6_20200902.lst')
ble_sites.remove('all_test_cases_huc8_20200902.lst')
ble_sites.remove('all_test_cases_huc4_20200902.lst')
branch_name_huc8 = 'ble_test_sites_huc8'
branch_name_huc6 = 'ble_test_sites_huc6'
stat_list = ['fim_1_0_0', 'fim_2_3_3', 'dev_b0bb2c6',branch_name_huc8,branch_name_huc6,'eval']
...
for site in ble_sites:
    print(site)
    huc_8_100_path=os.path.join(dir,site, 'performance_archive', 'development_versions', branch_name_huc8,'100yr','stats_summary.csv')
    huc_6_100_path=os.path.join(dir,site, 'performance_archive', 'development_versions', branch_name_huc6,'100yr','stats_summary.csv')
    if os.path.exists(huc_8_100_path) and os.path.exists(huc_8_100_path):
        eval_100_huc8 = pd.read_csv(huc_8_100_path,index_col=0)
        eval_100_huc6 = pd.read_csv(huc_6_100_path,index_col=0)
...
eval_all.to_csv('data/temp/ble_results_filter.csv')
