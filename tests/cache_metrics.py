...
def process_alpha_test(args):
    ...
    try:
        run_alpha_test(fim_run_dir, branch_name, test_id, return_interval, compare_to_previous=False, archive_results=True, run_structure_stats=False, waterbody_mask_technique='nwm_0')
