...
def inundate(
             rem,catchments,catchment_poly,hydro_table,forecast,hucs=None,hucs_layerName=None,subset_hucs=None,
    ...
    window_gen = __make_windows_generator(rem,catchments,catchment_poly,catchmentStagesDict,inundation_raster,inundation_polygon,
...
def __make_windows_generator(rem,catchments,catchment_poly,catchmentStagesDict,inundation_raster,inundation_polygon,
...
if __name__ == '__main__':
    ...
    parser.add_argument('-b','--catchment-polygon',help='catchment_vector',required=True)
